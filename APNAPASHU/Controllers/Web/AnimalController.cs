...
{
    /// <summary>
    /// Web Animal Controller - CRUD Template (GetAll, Upsert, UpdateStatus, Delete)
    /// </summary>
    ...
    public class AnimalController : BaseController
    {
        ...
        {
            _logger.LogInformation($"Web: Getting animals - Page {filter?.PageNumber}, Size {filter?.PageSize}");
        ...
        {
            _logger.LogInformation($"Web: Upserting animal: {upsertDto?.AnimalName}");
        ...
        {
            _logger.LogInformation($"Web: Updating animal status - ID: {statusDto?.AnimalId}, IsActive: {statusDto?.IsActive}");
        ...
        {
            _logger.LogInformation($"Web: Deleting animal with ID: {id}");
